...
export function Component({ mode = 'login' }: ComponentProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Successful login -> go to Admin root
      router.push('/admin');
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen w-screen bg-black relative overflow-hidden flex items-center justify-center">
      ...
      {/* Top radial glow */}
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[120vh] h-[60vh] rounded-b-[50%] bg-primary/40 blur-[80px]" />
      <motion.div 
        className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[100vh] h-[60vh] rounded-b-full bg-primary blur-[60px]"
        animate={{ 
              ...
              <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
                ...
                <div className="text-center space-y-1 mb-5">
                  <motion.div
                    ...
                    className="mx-auto w-14 h-14 rounded-full border-white/10 flex items-center justify-center relative overflow-hidden"
                  >
